...
Para los modelos que realizan pocas transformaciones y que consumen los otros modelos decidimos materializarlos en vistas, dado que requieren poco procesamiento. Este es el caso de all_claves, claves_bank_accs, claves_cards, claves_providers, claves_rendimientos y claves_transactions. Para el resto de los modelos la materialización es de tabla, ya que los datos no necesitan estar totalmente actualizados y deben ser consistentes a lo largo del día para los equipos de análisis.
